...
DESCRIPTION:	This tool takes a database DPU file and an Argument file, and
				...
				in the Argument file. The Argument file (generated by the
				config tool) should fill all the tags except the green rows in
				'PARAMETERS', and all the descriptions except the green rows
				in 'OUTPUTS' and 'PARAMETERS'.
				Note that this tool needs another file "para_def.txt" to run.
